...
public class FavoriteTwitterSearches extends Activity 
{
   ...
   private void makeTagGUI(String tag, int index)
   {
      ...
      // get deleteButton and register its listener
      Button deleteButton =
   ...
   public OnClickListener deleteButtonListener = new OnClickListener()
   {
      ...
      public void onClick(View v)
      {
          ...
          String tag = searchButton.getText().toString();
          savedSearches.edit().remove(tag).commit();

          queryTableLayout.removeView((View) v.getParent()); //removes the parent layout

          // in case the user presses edit before deleting
          queryEditText.setText(""); // clear queryEditText
          tagEditText.setText(""); // clear tagEditText
      } // end method onClick
   }; // end OnClickListener anonymous inner class
